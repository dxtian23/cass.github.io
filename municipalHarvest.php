...
if (isset($_POST['municipality']) && !empty($_POST['municipality'])) {
    ...
    $query = "SELECT * FROM harvest WHERE town = '$municipality'";
    ...
    <tr>
        ...
        <th class='control text-center'>Average Yield</th>
        <th class='control text-center'>Prod'n</th>
    </tr>";
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $tableHtml .= "<td class='text-center'>" . $row['aveyield'] . '</td>';
        $tableHtml .= "<td class='text-center'>" . $row['prodn'] . '</td>';
        $tableHtml .= "</tr>";
    }
    $tableHtml .= "</table>";
