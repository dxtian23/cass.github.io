...
<body>
	...
	<h1 class="planted">Cassava Planting Accomplishment Report</h1>
	</div>
<br>
	<section class="container bg-dark my-3 w-50 text-dark p-2">
		<form action="insertrecord.php" class="row-g3 rows" method="post">
		<div class="row">
			...
			<div class="col-md-12 mt-3">
				...
				<input type="text" class="form-control" name="barangay" id="barang" placeholder="Barangay" required>
			</div>
			<div class=" col-md-12 mt-3">
			...
			<div class="col-md-12 mt-3">
				<label for="harvest" class="form-label" >Total Area Planted:</label>
				<input type="text" name="area" class="form-control" id="area" placeholder="Area Planted (Hectares)" required>
			</div>
